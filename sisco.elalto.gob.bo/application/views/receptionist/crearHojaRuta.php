					...
					<div class="card card-secondary card-tabs">
						<div class="card-header p-0 pt-1">
							<ul class="nav nav-tabs">
								<li class="nav-item">
									<a class="nav-link active" id="TabHojaInicio" href="#activity" data-toggle="tab"><img src="<?= base_url() ?>assets/dist/img/svg/carpeta.svg" class="mb-1 " alt="proceso" style="margin-right: 3px;" width="15px"> Nuevas Hojas de Ruta</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="TabHojaProceso" href="#timeline" data-toggle="tab"><img src="<?= base_url() ?>assets/dist/img/svg/ajustes.svg" class="mb-1 " alt="proceso" style="margin-right: 3px;" width="18px">Mis Hojas de Ruta En Proceso</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="TabHojaSalida" href="#settings" data-toggle="tab"><img src="<?= base_url() ?>assets/dist/img/encuadernado.png" class="mb-1 " alt="concluido" style="margin-right: 3px;" width="18px">Mis Hojas de Ruta Concluidas</a>
								</li>
							</ul>
						</div>
										...
										<div class="col-md-12">
												<div class="card" style="margin-bottom: 6px;">
													...
													<div class="card-body p-2 table-responsive mailbox-messages" style="width: auto;overflow-x: auto;">
														<table id="example1" class="table  table-sm table-hover table-striped  table-bordered font-12 ">
															<thead>
																<tr>
																	<th></th>
																	<th>ACCIONES</th>
