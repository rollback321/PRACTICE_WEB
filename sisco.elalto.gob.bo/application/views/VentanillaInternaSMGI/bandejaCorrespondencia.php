			...
			<div class="card card-secondary card-tabs">
				...
				<div class="card-body p-2">
					<div class="tab-content" id="custom-tabs-one-tabContent">
						...
						<div class="tab-pane fade" id="TabRetractarView" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tabDerivado">
							<div class="col-md-12">
								<div class="card card-primary card-outline" style="margin-bottom: 6px;">
									<div class="card-body p-2">
										<!-- <div class="mailbox-controls">
										...
										<div class="table-responsive mailbox-messagesR">
											<table id="tableRetractar" class="table table-hover table-striped table-sm font-11">
												<thead>
													<tr>
														<!-- <th style="text-align: center;"></th> -->
														<th></th>
