...
$pdf->SetAuthor('SISCO');
$pdf->SetTitle('REPORTE HOJAS DE RUTA RECIBIDAS');
...
$pdf->Cell(0, 2, "REPORTE HOJAS DE RUTA RECIBIDAS", 0, 1, 'C');
$pdf->SetFont('HELVETICA', 'B', 10);
$pdf->Cell(0, 2, "DE: ". $recepcionista[0]->usu_nombres.' '.$recepcionista[0]->usu_apellidos  ."", 0, 1, 'C');
$pdf->SetFont('HELVETICA', 'B', 10);
...
$pdf->MultiCell(200, 8, 'EN EL PRESENTE DOCUMENTO SE DETALLAN '.$total2.' HOJA(S) DE RUTA ASIGNADA(S) POR EL (LA) FUNCIONARARIO(A): ' . $recepcionista[0]->usu_nombres.' '.$recepcionista[0]->usu_apellidos  . ', AL (LA) FUNCIONARIO(A): '.$this->session->userdata('usu_nombres') . ' ' . $this->session->userdata('usu_apellidos').' ES ASIGNADO EN FECHA: '.$fechaActual.' PARA SEGUIR CON LAS RESPECTIVA(S) PROSECUCION(ES) DEL(LOS) TRAMITE(S).', 0, 'L', 1, 2, $positionParrafoX, $positionParrafoY, true);
$pdf->StopTransform();
/////////////////////////////////////////////////////////
