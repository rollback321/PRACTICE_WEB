							...
							<div class="col-12">
								<fieldset class="fieldset_Content_tema">
									...
									<div class="form-group row ml-2 mr-2">
										<select id="usuInterno_id" name="usuInterno_id" class="form-control form-control-sm" required="" aria-invalid="false">
										</select>
									</div>
								</fieldset>
									...
									<fieldset class="fieldset_Content_tema">
										...
										<div class="row  ">
											<div class="form-group col-md-3">
											    <input id="his_id" name="his_id" value="<?php echo $datos1; ?>" hidden>
												<input id="cor_id" name="cor_id" value="<?php echo $datos2; ?>" hidden>
												<input id="pend_id" name="pend_id" value="<?php echo $datos3; ?>" hidden>
												<input id="cor_tipo" name="cor_tipo" value="<?php echo $datos5; ?>" hidden>
											...
											<div class="form-group col-md-3 mb-1 ">
												<label for="inputPassword4"><i class="fas fa-clipboard-list"></i> Plazo(Dias):</label>
