										...
										<fieldset class="fieldset_Content_tema" >
											...
											<div class="form-row">
												<div class="form-group col-md-4">
													<input type="number" class="form-control form-control-sm text-uppercase" id="codigoNewHoja_Edit" name="codigoNewHoja_Edit" style="border-radius: 9px;" placeholder="Ejemplo: 800150" onKeyPress="if(this.value.length==5) return false;">
												</div>
												<div class="input-group-append" style="height: 32px;" onclick="validarCodigoEdit()">
													<button type="button" class="btn btn-lg btn-default" style="padding: 0.5rem 0.8rem;font-size: 1rem;">
														<i class="fa fa-search"></i>
													</button>
												</div>
												<h5> <span title="3 New Messages" id="cod_GAMEA_VERIFICAR_EDITAR" class="" style=" margin-left: 10px;"></span></h5>
											</div>
										</fieldset>
