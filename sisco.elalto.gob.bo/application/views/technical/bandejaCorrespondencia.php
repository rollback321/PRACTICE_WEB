					...
					<div class="card card-secondary card-tabs">
						...
						<div class="card-body p-2">
							<div class="tab-content">
								...
								<div class="active tab-pane" id="TabInboxView">
									<div class="container-fluid">
										<div class="row">
											<div class="col-12">
												<div class="card" style="margin-bottom: 6px;">
													...
													<div class="card-body p-2 table-responsive mailbox-messages">
														<table id="tableInbox" class="table  table-sm table-hover table-striped  table-bordered font-12">
															<thead>
																<tr>
								...
								<div class="tab-pane" id="TabReceptionView">
									<div class="container-fluid">
										<div class="row">
											<div class="col-12">
												<div class="card" style="margin-bottom: 6px;">
													...
													<div class="card-body p-2 table-responsive mailbox-messagesR">
														<table id="tableReception" class="table table-sm table-hover table-striped  table-bordered font-12">
															<thead>
																<tr>
																	<th style="text-align: center;"></th>
																	<th>ACCIONES</th>
