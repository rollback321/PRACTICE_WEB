...
//obteniendo datos de los participantes
$sql =  "SELECT *
FROM participantes  
...
<h3>Registro de datos para la boleta de matriculación</h3>
...
<form action="../CboletaMatriculacion/insertarRegistro?id_doc=<?= $id_doc ?>&id_prog=<?= $id_prog ?>&id_part=<?= $id_part ?>" method="POST">
<br>
