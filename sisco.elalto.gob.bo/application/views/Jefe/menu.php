...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	<!-- Brand Logo -->
	<a href="<?=site_url("JefeControl");?>" class="brand-link">
	...
	<div class="sidebar">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item">
					<a href="<?=site_url("JefeControl/");?>" class="nav-link <?=$active[0];?>">
				...
				<li class="nav-item">
					<a href="<?=site_url("JefeControl/crearhojaruta");?>" class="nav-link <?=$active[1];?>">
				...
				<li class="nav-item">
					<a href="<?=site_url("JefeControl/adminUser");?>" class="nav-link <?=$active[2];?>">
				...
				<li class="nav-item">
					<a href="<?= site_url("JefeControl/contactos");?>" class="nav-link <?=$active[3];?>">
				 ...
				 <li class="nav-item">
					<a href="<?=site_url("JefeControl/searchHojaRuta");?>"  class="nav-link <?=$active[4];?>">
				...
				<li class="nav-item">
					<a href="<?=site_url("JefeControl/tutoriales");?>" class="nav-link <?=$active[5];?>">
