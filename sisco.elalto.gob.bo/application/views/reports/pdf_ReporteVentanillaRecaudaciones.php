...
$pdf->Image(base_url() . '/assets/dist/img/plantilla/escudo-elalto.jpg', 10, 12, 23, 28, 'JPG', 'http://www.google.com', '', true, 300, '', false, false, 0, false, false, false);
$pdf->SetFont('helvetica', 'B', 8);
$pdf->SetX(32);
$pdf->Cell(10, 19, 'GOBIERNO', 0, 0, 'L');
$pdf->SetX(32);
$pdf->Cell(10, 27, 'AUTONOMO', 0, 0, 'L');
$pdf->SetX(32);
$pdf->Cell(10, 35, 'MUNICIPAL', 0, 0, 'L');
$pdf->SetFont('helvetica', 'B', 8);
$pdf->SetX(32);
$pdf->Cell(10, 42, 'EL ALTO', 0, 0, 'L');
...
$pdf->Cell(0, 2, "VENTANILLA UNICA DIRECCION DE RECAUDACIONES", 0, 1, 'C');
$pdf->SetFont('HELVETICA', 'B', 12);
...
$pdf->Image(base_url() . '/assets/dist/img/plantilla/logo-gamea.jpg', 170.5, 15, 27, 22, 'JPG', 'http://www.google.com', '', true, 300, '', false, false, 0, false, false, false);
// $pdf->Ln(-1);
...
// Crear contenedor SECCION 2
    ...
    $contenedorSeccion4 = '
            ...
            <br><br><br><div>
            <table width="620" cellpadding="3" border="1" cellspacing="0" style="font-family: verdana, arial, helvetica; font-size: 8px; "> 
                <tr>    
                ...
                <th align="center" style="background-color:#D3D3D3;"  colspan="2"  width="10%"><b>FECHA<BR>RECEPCION</b></th>
                <th align="center" style="background-color:#D3D3D3;"  colspan="2"  width="15%"><b>DOCUMENTOS DE<BR>RECEPCION</b></th>
                </tr>
                <tbody>';
                ...
                for ( $i = 0; $i < $total; $i++) {
                    ...
                    <td align="center"  colspan="2"  width="10%"style="font-size:7px;">' . $codigo.'<br>'.$Origen.'</td>
                    ...
                    <td align="center"  colspan="2"  width="24%" style="font-size:7px;">' . $correspondencia[$i]->cor_descripcion.'</td>
                    ...
                    <td align="center"  colspan="2"  width="10%" style="font-size:7px;">' . $correspondencia[$i]->cor_create_at.'</td>
                    <td align="center"  colspan="2"  width="15%" style="font-size:7px;">' . $docum.'</td>
                    </tr> ';
                    $contador=$contador+1;
                }
        $contenedorSeccion4 .= '
            ...
            <p>VEIRIFIQUE LA CANTIDAD DE HOJA(S) DE RUTA(S) ASIGNADA(S) ANTES DE COLOCAR LOS SELLOSY ACALARCION DE FIRMA Y FECHA DE RECEPCION.</p>
            <br>
