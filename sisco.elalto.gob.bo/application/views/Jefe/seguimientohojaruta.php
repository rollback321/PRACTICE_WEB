...
<div class="content-wrapper">
	<div class="content">
		<div class="container-fluid">
			<div class="card card-default" id="VerDependencias">
				<div class="card-header">
					<h3 class="card-title"><img src="<?= base_url() ?>assets/dist/img/oficina.png" class="mb-2 " alt="dependencia" style="margin-left: 7px;" width="18px"> UNIDADES ORGANIZACIONALES DEPENDIENTES(G.A.M.E.A)</h3>
						...
						<div class="col-5 col-sm-5">
							<fieldset class="fieldset_Content_tema">
								...
								<label class="m-0  font-weight-normal" for="ingresoProveedor">
									<div class="form-group row ml-2 mr-2" id="div_select_nivel_1_SEARCH_DEPENDENCIA">
										<select class="form-control" id="select_nivel_1_SEARCH_DEPENDENCIA">
											<option selected="selected">Seleccionar Dependencia</option>
										</select>
									</div>
									<div class="form-group row ml-2 mr-2" id="div_select_nivel_2_SEARCH_DEPENDENCIA">
										<select class="form-control" id="select_nivel_2_SEARCH_DEPENDENCIA">
											<option selected="selected">Seleccionar Dependencia</option>
										</select>
									</div>
									<div class="form-group row ml-2 mr-2" id="div_select_nivel_3_SEARCH_DEPENDENCIA">
										<select class="form-control" id="select_nivel_3_SEARCH_DEPENDENCIA">
											<option selected="selected">Seleccionar Dependencia</option>
										</select>
									</div>
							</fieldset>
				...
				<div class="card-footer" style="display: flex;justify-content: center;">
					<button type="submit" class="btn btn-sm btn-info" id="BtnBuscarHojasDependencias" name="BtnBuscarHojasDependencias"><i class="fas fa-search"></i> Ver Detalles</button>
