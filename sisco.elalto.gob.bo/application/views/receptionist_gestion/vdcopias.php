					...
					<form id="formCrearCopias" method="post">
						...
						<div class="row ">
							<div class="col-12">
								...
								<div class="card p-2 ">
								<Label style="color: red;">Nota: La Primera Derivacion sera el Original y las demas seran Copias</Label>	
								<div class="card-header p-2 d-flex">
									...
									<div class="table-responsive">
										<table id="detalles" class="table table-striped table-hover table-condensed table-sm text-xs">
											<thead class=" justify-content-center"style="color: #000!important;">
												<th></th>
												<th>Nro.</th>
												<th>Origen</th>
												<th>Recepcionista</th>
