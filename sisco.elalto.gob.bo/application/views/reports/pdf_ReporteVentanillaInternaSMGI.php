...
$pdf->SetAuthor('SISCO');
$pdf->SetTitle('REPORTE VENTANILLA INTERNA SMGI');
...
$pdf->SetFont('HELVETICA', 'B', 16);
$pdf->Cell(0, 2, "VENTANILLA INTERNA S.M.G.I.", 0, 1, 'C');
$pdf->SetFont('HELVETICA', 'B', 12);
...
$datos = 'Oficina: Ventanilla Interna. Fecha de Reporte: '.$fecha;
...
// Crear contenedor SECCION 2
    ...
    $contenedorSeccion4 = '
            ...
            <table width="997" cellpadding="3" border="1" cellspacing="0" style="font-family: verdana, arial, helvetica; font-size: 11px; "> 
                ...
                <th align="center" style="background-color:#D3D3D3;"  colspan="2"  width="14%"><b>NOMBRE<BR>REMITENTE</b></th>
                <th align="center" style="background-color:#D3D3D3;"  colspan="2"  width="16%"><b>INSTITUTO<BR>REMITENTE</b></th>
                <th align="center" style="background-color:#D3D3D3;"  colspan="2"  width="15%"><b>FECHA<BR>RECEPCION</b></th>
                ...
                for ( $i = 0; $i < $total; $i++) {
                    ...
                    <td align="center"  colspan="2"  width="14%" style="font-size:9px;">' . $correspondencia[$i]->cor_nombre_remitente.'</td>
                    <td align="center"  colspan="2"  width="16%" style="font-size:9px;">' . $correspondencia[$i]->cor_institucion.'</td>
                    <td align="center"  colspan="2"  width="15%" style="font-size:9px;">' . $correspondencia[$i]->pend_create_at.'</td>
