<script>
	...
	function TableInbox() {
		...
		listInbox = $('#tableInbox').DataTable({
			"processing": true,
			"serverSide": false,
			"ajax": "<?= site_url('SecretaryControl/fetchInbox'); ?>",
			"ordering": true,
			"order": [
				[0, "asc"]
			],
	...
	function TableReception() {
		...
		listReception = $('#tableReception').DataTable({
			"processing": true,
			"serverSide": false,
			"ajax": "<?= site_url('SecretaryControl/fetchReception'); ?>",
			"ordering": true,
			"order": [
				[0, "asc"]
			],
	...
	function TableRetractar() {
		...
		listRetractar = $('#tableRetractar').DataTable({
			"processing": true,
			"serverSide": false,
			"ajax": "<?= site_url('SecretaryControl/fetchRetractar'); ?>",
			"ordering": true,
			"order": [
				[0, "asc"]
			],
	...
	function TableConcluidos() {
		...
		listConcluidos = $('#tableConcluidos').DataTable({
			"processing": true,
			"serverSide": false,
			"ajax": "<?= site_url('SecretaryControl/fetchConcluidos'); ?>",
			"ordering": true,
			"order": [
				[0, "asc"]
			],
