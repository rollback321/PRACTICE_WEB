					...
					<div class="col-md-12">
						<div class="form-group">
							<fieldset class="fieldset_Content_tema">
								...
								<input type="hidden" id="pend_id_interno" name="pend_id_interno">
							...
							<fieldset class="fieldset_Content_tema">
								...
								<div class="form-row">
									<div class="form-group col-md-12">
										...
										<textarea class="form-control form-control-sm text-uppercase" id="ViewDestinoProveidoDerivar" name="ViewDestinoProveidoDerivar" rows="2" style="border-radius: 9px;"></textarea>
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-12">
										<label for="inputPassword4"><i class="fas fa-file-invoice "></i> OBSERVACION</label>
										<textarea class="form-control form-control-sm text-uppercase" id="ViewDestinoObservacionDerivar" name="ViewDestinoObservacionDerivar" rows="1" style="border-radius: 9px;"></textarea>
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-12">
										<label for="inputPassword4"><i class="fas fa-calendar"></i> PLAZO(DIAS)</label>
										<textarea class="form-control form-control-sm text-uppercase" id="plazoViewDestinoDerivar" name="plazoViewDestinoDerivar" rows="1" style="border-radius: 9px;"></textarea>
									</div>
								</div>
							</fieldset>
