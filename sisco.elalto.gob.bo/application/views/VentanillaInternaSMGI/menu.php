		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				<!-- Add icons to the links using the .nav-icon class
					 ...
					 <li class="nav-item">
					<a href="<?=site_url("VentanillaInternaControlSMGI/");?>" class="nav-link <?=$active[0];?>">
				...
				<li class="nav-item">
					<a href="<?=site_url("VentanillaInternaControlSMGI/crearHojaRuta");?>" class="nav-link <?=$active[1];?>">
				...
				<li class="nav-item">
					<a href="<?=site_url("VentanillaInternaControlSMGI/reportes");?>" class="nav-link <?=$active[2];?>">
				...
				<li class="nav-item">
					<a href="<?= site_url("VentanillaInternaControlSMGI/contactos");?>" class="nav-link <?=$active[3];?>">
				...
				<li class="nav-item">
					<a href="<?=site_url("VentanillaInternaControlSMGI/searchHojaRuta");?>" class="nav-link <?=$active[4];?>">
				...
				<li class="nav-item">
					<a href="<?=site_url("VentanillaInternaControlSMGI/tutoriales");?>" class="nav-link <?=$active[5];?>">
