<script>
    ...
    function derivarHojaRutaExternaDirecta(cor_id, his_id, codigo) {
		$(".cod_GAMEA").text(codigo);
		$('#cor_id_ExternaDirecta').val(cor_id);
		$('#his_id_ExternaDirecta').val(his_id);
	...
	$("#form_derivarHojaRutaExternaDirecta").submit(function(e) {
		...
		$.ajax({
			type: 'POST',
			url: "<?= site_url("SecretaryControl/derivarHojaRutaExternaDirectaBandeja") ?>",
			data: $(this).serialize(),
			beforeSend: function() {
