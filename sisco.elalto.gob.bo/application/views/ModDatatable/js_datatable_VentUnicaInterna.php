<script>
	...
	function TableInicio() {
		...
		HojaRutaActiva = $('#example1').DataTable({
			"processing": true,
			"serverSide": false,
			"ajax": "<?= site_url('ventanillaInternaControlSMGI/fetch_Corresp'); ?>",
			"ordering": true,
			"order": [
				[0, "asc"]
			],
	...
	function TableProceso() {
		...
		HojaRutaActivaProccess = $('#example2').DataTable({
			"processing": true,
			"serverSide": false,
			"ajax": "<?= site_url('ventanillaInternaControlSMGI/fetch_CorrespProcess'); ?>",
			"ordering": true,
			"order": [
				[0, "asc"]
			],
	...
	function TableConcluido() {
		...
		HojaRutaActivaConcluded = $('#example3').DataTable({
			"processing": true,
			"serverSide": false,
			"ajax": "<?= site_url('ventanillaInternaControlSMGI/fetch_CorrespConcluded'); ?>",
			"ordering": true,
			"order": [
				[0, "asc"]
			],
