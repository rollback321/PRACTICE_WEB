									...
									<div class="bs-stepper-content pb-0">
										<div id="dependencia-part" class="content" role="tabpanel" aria-labelledby="dependencia-part-trigger">
											<div class="form-group mb-3">
												<input type="hidden" id="cor_idExtbandeja" name="cor_idExtbandeja">
												<input type="hidden" id="his_idExtbandeja" name="his_idExtbandeja">
												<input type="hidden" id="codigoExtbandeja" name="codigoExtbandeja">
											...
											<!-- <button type="button" id="btnlimpiarcontroles" class="btn btn-sm btn-outline-secondary float-left">Limpiar</button> -->
													...
													<div class="form-group col-lg-12">
														<div class="form-group row">
															...
															<div class="col-sm-12 col-md-10 col-lg-10 col-xl-10">
																<select class="form-control font-14" id="select_proveidoDerivacionExterno">
															...
															<div id="actions" class="row">
																<div class="col-lg-6">
																	<div class="btn-group w-100">
																		...
																		<button type="submit" class="btn btn-primary col start" style="display: none;">
