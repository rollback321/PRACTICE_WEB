	...
	<div class="sidebar">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				<li class="nav-item">
					<a href="<?=site_url("VentanillaUnicaRecaudacionesControl/");?>" class="nav-link <?=$active[0];?>">
				...
				<li class="nav-item">
					<a href="<?=site_url("VentanillaUnicaRecaudacionesControl/reportes");?>" class="nav-link <?=$active[1];?>">
				...
				<li class="nav-item">
					<a href="<?= site_url("VentanillaUnicaRecaudacionesControl/contactos");?>" class="nav-link <?=$active[2];?>">
				...
				<li class="nav-item">
					<a href="<?=site_url("VentanillaUnicaRecaudacionesControl/searchHojaRuta");?>" class="nav-link <?=$active[3];?>">
				...
				<li class="nav-item">
					<a href="<?=site_url("VentanillaUnicaRecaudacionesControl/tutoriales");?>" class="nav-link <?=$active[4];?>">
