			...
			<form id="form_crearHoja" method="post">
				<div id="modalCuerpo" class="modal-body" style="height: auto;width: auto;">
					<fieldset class="fieldset_Content_tema">
						<legend class="legend_tema"> <i class="fas fa-file-invoice "></i> CODIGO</legend>
						<div class="form-row">
							<div class="form-group col-md-4">
								<input type="number" class="form-control form-control-sm text-uppercase" id="codigoNewHoja" name="codigoNewHoja" style="border-radius: 9px;" placeholder="Ejemplo: 800150" onKeyPress="if(this.value.length==5) return false;">
							</div>
							<div class="input-group-append" style="height: 32px;" onclick="validar()">
								<button type="button" class="btn btn-lg btn-default" style="padding: 0.5rem 0.8rem;font-size: 1rem;">
									<i class="fa fa-search"></i>
								</button>
							</div>
							<h5> <span title="3 New Messages" id="cod_GAMEA_VERIFICAR" class="" style=" margin-left: 10px;"></span></h5>
						</div>
					</fieldset>
					<fieldset class="fieldset_Content_tema">
				...
				<div class="modal-footer">
					...
					<button type="submit" id="enviarHojaRuta" class="btn btn-primary"> <i class="fas fa-check"></i> Registar</button>
				</div>
			</form>
		</div>
	</div>
